...
const en = {
  ...
  admin: {
    ...
    heroManagement: {
      ...
      description: "Manage the homepage Hero mode, content, CTAs, and technology badges.",
      settingsTitle: "Hero Settings",
      settingsDescription: "Choose the public Hero mode and language shown on the homepage.",
      contentTitle: "Hero Content",
      contentDescription: "Edit the copy and CTA links for every mode and language variation.",
      technologiesTitle: "Hero Technologies",
      technologiesDescription: "Choose the technology badges shown beneath each Hero variation.",
      ...
      save: "Save Changes",
      saved: "Hero changes saved successfully.",
    },
    about: {
...
const fa: DeepPartial<Dictionary> = {
  ...
  admin: {
    ...
    heroManagement: {
      title: "مدیریت هیرو",
      description: "حالت، محتوا، CTAها و نشان‌های تکنولوژی بخش هیروی صفحه اصلی را مدیریت کنید.",
      settingsTitle: "تنظیمات هیرو",
      settingsDescription: "حالت و زبان هیروی نمایش‌داده‌شده در صفحه اصلی را انتخاب کنید.",
      contentTitle: "محتوای هیرو",
      contentDescription: "متن و لینک‌های CTA را برای هر حالت و زبان ویرایش کنید.",
      technologiesTitle: "تکنولوژی‌های هیرو",
      technologiesDescription: "نشان‌های تکنولوژی نمایش‌داده‌شده زیر هر نسخه هیرو را انتخاب کنید.",
      activeMode: "حالت فعال",
      activeLanguage: "زبان فعال",
      freelancerMode: "حالت فریلنسر",
      hiringMode: "حالت استخدام",
      persian: "فارسی",
      english: "انگلیسی",
      greeting: "خوش‌آمد",
      mainTitle: "عنوان اصلی",
      highlightedTitle: "عنوان برجسته",
      descriptionLabel: "توضیحات",
      primaryCta: "CTA اصلی",
      secondaryCta: "CTA دوم",
      ctaLabel: "متن",
      ctaLink: "لینک",
      technologies: "تکنولوژی‌ها",
      save: "ذخیره تغییرات",
      saved: "تغییرات هیرو با موفقیت ذخیره شد.",
    },
    about: {
